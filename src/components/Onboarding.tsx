...
const goalOptions = [
  { id: 'anxiety', label: 'Manage Anxiety', description: 'Learn coping strategies and techniques' },
  { id: 'mood', label: 'Track Mood', description: 'Monitor emotional patterns and trends' },
  { id: 'mindfulness', label: 'Practice Mindfulness', description: 'Build meditation and awareness habits' },
  { id: 'sleep', label: 'Improve Sleep', description: 'Develop better sleep hygiene' },
  { id: 'stress', label: 'Reduce Stress', description: 'Learn stress management techniques' },
  { id: 'habits', label: 'Build Healthy Habits', description: 'Create positive daily routines' }
];

const experienceOptions = [
  { id: 'beginner', label: 'New to mental health apps', description: 'I\'m just starting my wellness journey' },
  { id: 'some', label: 'Some experience', description: 'I\'ve tried a few wellness apps or techniques' },
  { id: 'experienced', label: 'Very experienced', description: 'I\'m familiar with CBT and mindfulness practices' }
];
          ...
          <div className="text-center space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Monitor your wellbeing</p>
              </div>
              <div className="text-center space-y-2">
      ...
      case 2:
        return (
          <div className="space-y-6">
            <div className="text-center space-y-2">
              <h2 className="text-2xl font-bold">What are your wellness goals?</h2>
              <p className="text-muted-foreground">Choose all that apply. We'll personalize your experience.</p>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-muted-foreground">This helps us provide the right level of guidance.</p>
            </div>
            <RadioGroup
            ...
            >
              {experienceOptions.map((option) => (
                <Card
                  ...
                  onClick={() => setOnboardingData(prev => ({ ...prev, experience: option.id }))}
                >
                  <CardContent className="p-4">
                    <div className="flex items-start space-x-3">
        ...
        return (
          <div className="space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-muted-foreground">We'll prioritize these features for you.</p>
            </div>
              ...
              {interestOptions.map((interest) => (
                ...
                >
                  <CardContent className="p-3 text-center">
                    <Checkbox
                      checked={onboardingData.interests.includes(interest.id)}
                      className="mb-2"
                    />
            ...
            <div className="space-y-3">
              ...
              <Input
                ...
                onChange={(e) => setOnboardingData(prev => ({ ...prev, reminderTime: e.target.value }))}
                className="w-full"
              />
              <p className="text-sm text-muted-foreground">
                We'll send you a gentle reminder to check in with your wellbeing.
              </p>
            </div>
          </div>
        );
        ...
        return (
          <div className="text-center space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground text-lg max-w-md mx-auto">
                Your personalized wellness journey is ready. Remember, small steps lead to big changes.
              </p>
            </div>
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  <p className="font-medium text-blue-800">Selected Goals:</p>
                  <ul className="text-blue-700 mt-1">
                    {onboardingData.goals.map(goalId => (
                      <li key={goalId}>• {goalOptions.find(g => g.id === goalId)?.label}</li>
                    ))}
                  </ul>
                </div>
                <div>
                  <p className="font-medium text-blue-800">Interests:</p>
                  <ul className="text-blue-700 mt-1">
                    {onboardingData.interests.map(interestId => (
                      <li key={interestId}>• {interestOptions.find(i => i.id === interestId)?.label}</li>
                    ))}
                  </ul>
                </div>
              </div>
